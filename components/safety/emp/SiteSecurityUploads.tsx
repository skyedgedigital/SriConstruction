...
const SiteSecurityUploads = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        const res = await weeklyAuditAction.FETCH.fetchSiteSecurityUploads();
    ...
    const handleUpload = () => {
      ...
      uploadTask.on('state_changed', 
        ...
        async () => {
          ...
          const resp = await weeklyAuditAction.CREATE.createSiteSecurityUploads(JSON.stringify(obj))
          if (resp.success) {
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <h2 className="text-2xl text-center mb-6">Upload Site Security File</h2>
