...
const Page = ({
  ...
  const generatePDF = async () => {
    ...
    const ogId = `BonusStatement/${searchParams.year}`;
    ...
    // tdElements.forEach((table) => {
    //     table.style.fontWeight = 'bold'; // Set the desired font size here
    // });
  ...
  return (
    <div>
      ...
      <div ref={contentRef} id={`BonusStatement/${searchParams.year}`}>
        <div
        ...
        >
          <div className='max-w-3xl mx-auto mt-10 font-sans leading-relaxed'>
            ...
            <div className='flex justify-between mb-10'>
              <p>Regarding: Fund Transfer for Bonus Payment</p>
          ...
          <div className='flex justify-between  left-0  ml-0 mb-10 p-8'>
            ...
            <div className='flex flex-col'>
              <h1 className='  mb-4  text-center'>{`Bonus Statement for`}</h1>
