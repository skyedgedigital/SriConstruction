...
const ViewHouseKeepingAudit = () => {
    const [result, setResult] = useState([]);
    useEffect(() => {
        const fn = async () => {
          const resp = await weeklyAuditAction.FETCH.fetchAllHouseKeepingAudit();
          console.warn(resp);
          if (resp.data) {
    ...
    const handleDelete = async(id:any) => {
        const resp = await weeklyAuditAction.DELETE.deleteHouseKeepingAudit(id)
        if(resp.success){
...
export default ViewHouseKeepingAudit
