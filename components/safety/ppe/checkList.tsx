...
const CheckList = () => {
  ...
  const generatePDF = () => {
    ...
    const pdfName = `PPE_CheckList_${selectedDate || "No_Date"}.pdf`;
    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then(async(downloadURL) => {
          ...
          const resp = await PpeAction.CREATE.createCheckList(JSON.stringify(obj))
          if(resp.success){
            toast.success("CheckList Saved");
          }
          else{
            toast.error("CheckList Not Saved")
          }
  ...
  return (
    <>
      <div style={{ width: "100%", overflowX: "auto" }}>
        <div className="text-2xl flex justify-center my-4">PPE CheckList</div>
