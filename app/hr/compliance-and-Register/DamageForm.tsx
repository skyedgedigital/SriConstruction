...
const DamageRegister = () => {
  ...
  const handleGenerateRegister: SubmitHandler<DateFormFields> = (data) => {
    ...
    dateForm.reset();
    window.open(`/hr/compliance-and-Register/damage-register?fromData=${data.fromDate}&toData=${data.toDate}`);
  };
  ...
  const onSubmitEmployee: SubmitHandler<EmployeeFormFields> = async (data) => {
    ...
    try {
      ...
      const response = await ComplianceRegisterAction.CREATE.addEmployeeToDamageRegister(payload);
      ...
      <Form {...employeeForm}>
        ...
        >
            ...
            {[
                ...
                { label: "Particulars of Damage or Loss", name: "damageDetails" },
                { label: "Date of Damage or Loss", name: "damageDate", type: "date" },
                { label: "Did Workman Show Cause?", name: "showedCause" },
                { label: "Person Who Heard Explanation", name: "explanationPerson" },
                { label: "Amount of Deduction Imposed", name: "deductionAmount", type: "number" },
