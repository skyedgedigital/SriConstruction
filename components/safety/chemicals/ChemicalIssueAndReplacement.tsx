...
const ChemicalIssueAndReplacement = () => {
  ...
  const handleSubmit = async () => {
    ...
    let fileName = 'Chemical_Issue_And_Replacement_' + (selectedDate !== "" ? `${selectedDate}` : "No_Date_Selected")+'.xlsx';
...
export default ChemicalIssueAndReplacement;
