    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        try {
          ...
          const filteredData = (esiState === "All")
              ? parsedData
              ...
              <PDFTable className='border-2 border-black'>
                <TableHeader className='py-8 h-24 overflow-auto'>
                  <TableRow className='text-black font-mono h-28'>
                    <TableHead className='bg-slate-400 text-black border-2 border-black'>Sl No.</TableHead>
                    <TableHead className='bg-slate-400 text-black border-2 border-black'>IP Number (10 Digits)</TableHead>
                  {/* <TableHead className='bg-slate-400 text-black border-2 border-black'>P.F. No.</TableHead> */}
                    <TableHead className='bg-slate-400 text-black border-2 border-black'>IP Name (Alphabetical only)</TableHead>
                    <TableHead className='bg-slate-400 text-black border-2 border-black'>No. of days for which wages paid/payable</TableHead>
                    <TableHead className='bg-slate-400 text-black border-2 border-black'>Total Monthly Wage</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {attendanceData.map((employee, index) => (
                    <TableRow key={employee._id} className='h-16'>
                      ...
                      <TableCell className='border-black border-2 text-black'>{employee?.employee?.ESICNo}</TableCell>
